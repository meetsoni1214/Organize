...
import com.example.organize.databinding.FragmentTwitterBinding
...
class TwitterFragment : Fragment() {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        binding.apply {
            ...
            fragmentTwitter = this@TwitterFragment
        }
    }
    fun  goToEditScreen() {
        findNavController().navigate(R.id.action_twitterFragment_to_twitterEditFragment)
    }
